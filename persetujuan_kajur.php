<?php
session_start();
if (!isset($_SESSION['user_id']) || $_SESSION['role'] !== 'Wakil Dekan III') {
...
function sendApprovalEmail($email, $nama_lengkap) {
    ...
    try {
        ...
        // Pengaturan penerima
        $mail->setFrom('adriansyahsumitra@gmail.com', 'Ketua Jurusan');
...
if (isset($_POST['approve']) || isset($_POST['reject'])) {
    ...
    $query = "UPDATE persetujuan SET status = ? WHERE id = ?";
...
<body>
    ...
    <div class="sidebar bg-light p-3" id="sidebar">
        ...
        <nav class="nav flex-column mt-2">
            ...
            <a class="nav-link d-flex align-items-center text-dark" href="persetujuan_kajur.php" style="color: black;">
            ...
            <a class="nav-link d-flex align-items-center text-dark" href="tanggal_kajur.php" style="color: black;">
